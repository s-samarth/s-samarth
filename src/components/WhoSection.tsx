...
const manifesto =
  "I'm Samarth, A *Product Builder* at Heart, *Engineer* at Core and a *Sales* guy because I am usually broke. Bring me the messy problem. I'll build the *AI agent*, the *RAG*, the *model*, or talk you out of all three. IIT Guwahati taught me to take problems seriously. Stand-up taught me not to take myself seriously.";
