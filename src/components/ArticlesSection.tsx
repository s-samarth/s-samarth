...
const articles = [
  ...
  {
    title: "Instagram Knows You Better Than Your Therapist",
  ...
  return (
    <section id="articles" className="section-padding relative">
      <div className="container-narrow relative" ref={ref}>
        ...
        >
          <p className="text-primary text-sm tracking-widest uppercase mb-4">Writing</p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {articles.map((article, index) => (
            <motion.a
              ...
              className="glass-card-hover rounded-2xl p-6 flex flex-col justify-between group cursor-pointer"
            >
              <div>
